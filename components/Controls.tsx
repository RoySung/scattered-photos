        ...
        <div className="p-4 bg-black/80 backdrop-blur-xl rounded-2xl border border-white/10 shadow-2xl animate-in fade-in slide-in-from-bottom-4 flex flex-col gap-3 min-w-[200px]">
          ...
          <div className="flex gap-3 justify-center">
            ...
            >
              ...
              <span className="relative text-xs text-white/70 font-bold">
                Def
              </span>
            </button>
            ...
            {/* Color Picker */}
            <div
              className="relative w-10 h-10 rounded-full overflow-hidden border border-white/20 hover:border-white/60 transition-all cursor-pointer group bg-stone-800"
              title="Solid Color"
            >
              <input
                type="color"
        ...
        {hasPhotos && (
          <>
            ...
            <button
              ...
              className="p-2 text-violet-400 hover:text-violet-300 hover:bg-violet-500/10 rounded-full transition-all"
              title="Animate & Export Video"
            >
